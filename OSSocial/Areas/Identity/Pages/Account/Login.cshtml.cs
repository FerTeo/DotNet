...
namespace OSSocial.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //daca contine @ atunci cautam in email-uri mai intai
            ...
            else
            {
                ...
                //easter egg???
                if (user.AccessFailedCount > 0 &&  user.AccessFailedCount % 2 == 0)
                {
                    ModelState.AddModelError(string.Empty, "forgot your password huh?");
                }
                else
                {
